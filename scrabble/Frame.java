package scrabble;
	...
	public class Frame {
		...
		public boolean check_letters(Tile... c) { // This checks if the letters are avalaible or not returning a suitable
													// boolean
		...
		public boolean fill_frame(Tile... t) { // fills the frame with variable amount of arguments
