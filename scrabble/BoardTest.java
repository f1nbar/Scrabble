...
public class BoardTest {
	...
	public void testGetSquareValue() {
		...
		assertEquals("TW", board.getSquareValue("014"));
		...
		// regular tiles
		assertNull(board.getSquareValue("01"));
		assertNull(board.getSquareValue("100"));
		assertNull(board.getSquareValue("1115"));
		assertNull(board.getSquareValue("613"));
		assertNull(board.getSquareValue("38"));
